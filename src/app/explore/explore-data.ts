export const exploreData = {
  connections: [
    {
      id: "sep_club",
      label: "SEP Entrepreneurship Club",
      ...
      people: [
        {
          profile: {
            ...
            linkedin_url: "https://linkedin.com/in/sara-chen"
          },
          experience: [
            {
              title: "Founder & CEO",
          ...
          connectReason: "SEP Club member who founded a successful fintech startup after graduation."
        },
        {
          profile: {
          ...
          connectReason: "Former SEP leader who went into venture capital - great connection for startup funding advice."
        }
      ]
    },
    {
      id: "stanford_alum",
      label: "Stanford Alumni",
      ...
      people: [
        {
          ...
          connectReason: "Stanford CS grad who can share insights about engineering culture at Netflix."
        },
        {
          profile: {
            id: "david-kim",
          ...
          connectReason: "Stanford Design School alum who's working on next-gen products at Apple."
        }
      ]
    },
    {
      id: "hackathon_winners",
      label: "LA Hacks Winners",
      ...
      people: [
        {
          profile: {
            ...
            linkedin_url: "https://linkedin.com/in/sophia-williams"
          },
          experience: [
            {
              title: "Machine Learning Engineer",
          ...
          connectReason: "LA Hacks 2022 winner who joined OpenAI's reinforcement learning team."
        }
      ]
    },
    {
      ...
      people: [
        {
          profile: {
            ...
            linkedin_url: "https://linkedin.com/in/lisa-park"
          },
          experience: [
            {
              title: "Research Scientist",
          ...
          connectReason: "Publishing in the same NLP conferences, working on large language models."
        }
      ]
    },
    {
      ...
      people: [
        {
          profile: {
            ...
            linkedin_url: "https://linkedin.com/in/jessica-murphy"
          },
          experience: [
            {
              title: "Technical Recruiter",
          ...
          connectReason: "Actively recruiting for ML engineering roles at Amazon AWS."
        },
        {
          profile: {
            id: "chris-johnson",
          ...
          connectReason: "Helps a16z portfolio companies find technical talent."
        }
      ]
    },
    {
      ...
      people: [
        {
          profile: {
            ...
            linkedin_url: "https://linkedin.com/in/olivia-smith"
          },
          experience: [
            {
              title: "Senior Frontend Engineer",
          ...
          connectReason: "Met at a React meetup in San Francisco, working on design systems."
        },
        {
          profile: {
            id: "ethan-brown",
            ...
            linkedin_url: "https://linkedin.com/in/ethan-brown"
          },
          experience: [
            {
              title: "Engineering Director",
          ...
          connectReason: "Connected at SF TechWeek, interested in engineering leadership discussions."
        }
      ]
    }
  ]
